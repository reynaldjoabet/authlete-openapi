...
/**
  ...
  * @param expiresAt
  *   The time at which the access token expires (milliseconds since Unix epoch).
  * @param subject
  ...
  * @param grantId
  *   The value of the `grant_id` request parameter from the device authorization request.
  * @param grant
  ...
  * @param acr
  *   The Authentication Context Class Reference of the user authentication during access token
  *   issuance.
  * @param authTime
