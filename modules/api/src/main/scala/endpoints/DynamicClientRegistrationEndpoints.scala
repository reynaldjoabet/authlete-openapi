...
final case class DynamicClientRegistrationEndpoints() extends BaseEndpoint {
  ...
  /**
    ...
    * that complies with RFC 7591 (OAuth 2.0 Dynamic Client Registration Protocol).
  ...
  /**
    ...
    * registration management endpoint that complies with RFC 7592. /api/client/registration/delete
    * API
    */
  ...
  /**
    ...
    * registration management endpoint that complies with RFC 7592. /api/client/registration/get API
    */
  ...
  /**
    ...
    * registration management endpoint that complies with RFC 7592. /api/client/registration/update
    * API
    */
