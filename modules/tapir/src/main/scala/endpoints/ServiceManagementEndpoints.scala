...
case class ServiceCreateApiRequest(service: Option[Service])
case class ServiceDeleteApiRequest(serviceApiKey: String)
case class ServiceGetApiRequest(serviceApiKey: String)
case class ServiceGetListApiRequest(start: Option[Int], end: Option[Int])
case class ServiceUpdateApiRequest(
