...
final case class ClientManagementEndpoints() extends BaseEndpoint {
  ...
  /** Delete all existing access tokens issued to a client application by an
    * end-user. /api/client/authorization/delete/{clientId}/{subject} API
    */
  ...
  /** Get a list of client applications that an end-user has authorized. The
    ...
    * a query parameter. /api/client/authorization/get/list/{subject} API
    */
  ...
  /** Update attributes of all existing access tokens given to a client
    * application. /api/client/authorization/update/{clientId} API
    */
  ...
  /** Lock and unlock a client /api/client/lock_flag/update/{clientIdentifier}
    * API
    */
  ...
  /** Delete the set of scopes that an end-user has granted to a client
    * application. /api/client/granted_scopes/delete/{clientId}/{subject} API
    */
  ...
  /** Refresh the client secret of a client. A new value of the client secret
    * will be generated by the Authlete server. /api/client/secret/refresh API
    */
  ...
  /** Update the client secret of a client. If you want to have the Authlete
    ...
    * `/api/client/secret/refresh` API. /api/client/secret/update API
    */
  ...
  case class ClientAuthorizationDeleteApiRequest(
      clientId: String,
      subject: String
  )
  case class ClientAuthorizationGetListApiRequest(
      subject: String,
      subject2: String,
  ...
  case class ClientAuthorizationUpdateApiRequest(
      clientId: String,
      clientAuthorizationUpdateRequest: Option[ClientAuthorizationUpdateRequest]
  )
  case class ClientCreateApiRequest(client: Option[Client])
  case class ClientDeleteApiRequest(clientId: String)
  case class ClientFlagUpdateApiRequest(
      clientIdentifier: String,
      clientFlagUpdateRequest: Option[ClientFlagUpdateRequest]
  )
  case class ClientGetApiRequest(clientId: String)
  case class ClientGetListApiRequest(
      developer: Option[String],
      start: Option[Int],
      end: Option[Int]
  )
  case class ClientGrantedScopesDeleteApiRequest(
      clientId: String,
      subject: String
  )
  case class ClientGrantedScopesGetApiRequest(
      clientId: String,
      subject: String,
      subject2: String
  )
  case class ClientSecretRefreshApiRequest(clientIdentifier: String)
  case class ClientSecretUpdateApiRequest(
      clientIdentifier: String,
      clientSecretUpdateRequest: ClientSecretUpdateRequest
  )
  //case class ClientUpdateApiRequest(clientId: String, client: Option[Client])
}
