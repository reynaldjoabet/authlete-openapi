...
/** @param resultCode
  ...
  *   device authorization request is the client ID alias.
  * @param clientName
  ...
  * @param claimNames
  *   The names of the claims which were requested indirectly via special
  *   scopes.
  * @param acrs
  ...
  *   The authorization details associated with the device verification
  *   response.
  ...
  * @param expiresAt
  *   The date in milliseconds since the Unix epoch at which the user code will
  *   expire.
  * @param gmAction
