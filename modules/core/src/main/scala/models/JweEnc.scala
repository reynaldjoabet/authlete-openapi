...
/** This is the encryption algorithm to be used when encrypting a JWT on client
  ...
  * by the client or by the server. For instance:
  *   - as `authorizationEncryptionEnc` value, it refers to the encryption
  *     algorithm used by server when creating a JARM response
  ...
  */
enum JweEnc(val value: String) derives Codec.AsObject {
