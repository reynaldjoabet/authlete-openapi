...
/** @param number
  ...
  *   `client_name` in OpenID Connect Dynamic Client Registration 1.0, 2. Client
  *   Metadata.
  * @param clientNames
  ...
  *   letters). The value of this property is assigned by Authlete.
  * @param clientIdAlias
  ...
  *   `sector_identifier_uri` or the registered redirect URI.
  * @param jwksUri
  ...
  *   client makes a backchannel authentication request.
  * @param attributes
  ...
  *   The flag to indicate whether the client is expected to sign requests to
  *   the resource server.
  * @param dpopRequired
  *   If the DPoP is required for this client.
  * @param automaticallyRegistered
  *   The flag indicating whether this client was registered by the "automatic"
  ...
  *   The human-readable name representing the organization that manages this
  *   client.
  * @param signedJwksUri
  *   The URI of the endpoint that returns this client's JWK Set document in the
  *   JWT format.
  * @param entityId
  ...
  *   The time at which the trust chain expires. The value is represented as
  *   milliseconds since the UNIX epoch (1970-01-01).
